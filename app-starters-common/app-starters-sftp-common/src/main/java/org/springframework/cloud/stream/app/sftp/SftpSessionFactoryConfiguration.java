...
public class SftpSessionFactoryConfiguration {
	...
	public SessionFactory<LsEntry> sftpSessionFactory(SftpSessionFactoryProperties properties) {
		...
		sftpSessionFactory.setHost(properties.getHost());// localhost
		sftpSessionFactory.setPort(properties.getPort());// 22
		sftpSessionFactory.setUser(properties.getUsername());// null
		sftpSessionFactory.setPassword(properties.getPassword());// null
		sftpSessionFactory.setAllowUnknownKeys(properties.isAllowUnknownKeys()); //false
